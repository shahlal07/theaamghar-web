...
// Single source for the Google button so /login and /signup can't drift in
// markup or in the redirectTo they hand Supabase (getting that wrong is how
// an OAuth round-trip silently lands the customer on the wrong domain).
