export function NashemannLoader() {
  return (
    <div className="fixed inset-0 z-[9999] flex min-h-screen items-center justify-center overflow-hidden bg-[#f7faf8]/95 px-6 backdrop-blur-xl">
      ...
      <div className="relative w-full max-w-sm rounded-[28px] border border-white/80 bg-white/55 px-7 py-8 text-center shadow-[0_20px_70px_rgba(34,55,45,0.08)] backdrop-blur-2xl">
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-[20px] bg-white/80 shadow-[0_8px_24px_rgba(34,55,45,0.08)]">
