...
function LoginForm() {
  ...
  return (
    <AuthSplitLayout
      ...
      subhead="Sign in to track orders, manage your wishlist, and pick up right where you left off."
    >
      <h1 className="font-serif text-3xl font-bold text-center mb-2">Welcome Back</h1>
      <p className="text-ink-light text-center mb-6">Sign in to your TheAamGhar account</p>
